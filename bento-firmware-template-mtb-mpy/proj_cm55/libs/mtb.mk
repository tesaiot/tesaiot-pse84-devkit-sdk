...
SEARCH_freertos=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/freertos/release-v10.6.201
SEARCH_ifx-mbedtls=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/ifx-mbedtls/release-v3.6.400
SEARCH_lvgl=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/lvgl/release-v9.5.0
SEARCH_ml-middleware=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/ml-middleware/release-v3.1.0
SEARCH_ml-tflite-micro=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/ml-tflite-micro/release-v3.1.0
SEARCH_mqtt=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/mqtt/release-v4.7.0
SEARCH_optiga-trust-m=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/optiga-trust-m/release-v5.3.0
