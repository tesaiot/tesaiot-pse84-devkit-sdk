...
const cy_stc_gpio_pin_config_t CYBSP_POT_VR1_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = CYBSP_POT_VR1_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t CYBSP_POT_VR2_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = CYBSP_POT_VR2_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t CYBSP_POT_VR3_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = CYBSP_POT_VR3_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
const cy_stc_gpio_pin_config_t CYBSP_POT_VR4_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_ANALOG,
    .hsiom = CYBSP_POT_VR4_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
void init_cycfg_pins(void)
{
    ...
    Cy_GPIO_Pin_Init(CYBSP_POT_VR1_PORT, CYBSP_POT_VR1_PIN, &CYBSP_POT_VR1_config);
    Cy_GPIO_Pin_Init(CYBSP_POT_VR2_PORT, CYBSP_POT_VR2_PIN, &CYBSP_POT_VR2_config);
    Cy_GPIO_Pin_Init(CYBSP_POT_VR3_PORT, CYBSP_POT_VR3_PIN, &CYBSP_POT_VR3_config);
    Cy_GPIO_Pin_Init(CYBSP_POT_VR4_PORT, CYBSP_POT_VR4_PIN, &CYBSP_POT_VR4_config);
