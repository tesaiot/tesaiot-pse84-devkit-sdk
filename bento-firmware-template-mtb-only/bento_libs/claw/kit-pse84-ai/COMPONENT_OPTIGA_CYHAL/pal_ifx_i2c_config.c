...
/* Bus selection must match OPTIGA_I2C_SCB_HW in pal_i2c.c:
 * default = SCB0 (P8.0/P8.1 1V8); OPTIGA_I2C_ON_3V3_BUS = SCB5 (P17.0/P17.1). */
#ifdef OPTIGA_I2C_ON_3V3_BUS
#define OPTIGA_I2C_SCB_hal_config  CYBSP_I2C_CAM_CONTROLLER_hal_config
#else
#define OPTIGA_I2C_SCB_hal_config  CYBSP_I2C_CONTROLLER_hal_config
#endif

pal_psoc_i2c_t optiga_i2c_master_config =
{
    .i2c_controller_channel = &i2c_master_obj,
    .dev_config = &OPTIGA_I2C_SCB_hal_config,
